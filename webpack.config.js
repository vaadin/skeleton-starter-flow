...
const fileNameOfTheFlowGeneratedMainEntryPoint = require('path').resolve(__dirname, 'target/frontend/module');
...
module.exports = {
  ...
  devServer: {
    ...
    contentBase: [mavenOutputFolderForFlowBundledFiles, buildFolder, 'src/main/webapp'],
